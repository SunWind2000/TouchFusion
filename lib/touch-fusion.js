...
const q = 6, B = 24;
var r = /* @__PURE__ */ ((s) => (s[s.Start = 1] = "Start", s[s.Move = 2] = "Move", s[s.End = 4] = "End", s[s.Cancel = 8] = "Cancel", s))(r || {}), _ = /* @__PURE__ */ ((s) => (s.Touch = "touch", s.Mouse = "mouse", s.Pen = "pen", s.Kinect = "kinect", s))(_ || {});
const U = 25, j = /mobile|tablet|ip(ad|hone|od)|android/i, E = "ontouchstart" in window || navigator.maxTouchPoints > 0, H = "PointerEvent" in window, Y = E && j.test(navigator.userAgent);
var c = /* @__PURE__ */ ((s) => (s[s.Possible = 1] = "Possible", s[s.Began = 2] = "Began", s[s.Changed = 4] = "Changed", s[s.Ended = 8] = "Ended", s[s.Canceled = 16] = "Canceled", s[s.Failed = 32] = "Failed", s))(c || {}), v = /* @__PURE__ */ ((s) => (s.Secret = "touch-fusion.input", s.Unknown = "unknown", s.Swipe = "swipe", s.Pan = "pan", s.Pinch = "pinch", s.Rotate = "rotate", s.Press = "press", s.Tap = "tap", s))(v || {}), k = /* @__PURE__ */ ((s) => (s.COMPUTE = "compute", s.AUTO = "auto", s.MANIPULATION = "manipulation", s.NONE = "none", s.PAN_X = "pan-x", s.PAN_Y = "pan-y", s))(k || {});
const D = [
  "none",
  "pan-x",
  "pan-y",
  ...
  RECOGNIZER_TYPE: v,
  STOP_TYPE: y,
  SUPPORT_ONLY_TOUCH: Y,
  SUPPORT_POINTER_EVENTS: H,
  SUPPORT_TOUCH: E,
  TOUCH_ACTION: k
...
}, $ = (s) => typeof s == "boolean", it = (s) => typeof s == "number", z = (s) => typeof s == "string", O = (s) => typeof s == "function", I = (s) => s === null || Object.prototype.toString.call(s) === "[object Array]" ? !1 : typeof s == "object", f = (s) => Array.isArray(s), ot = (s) => s instanceof Element, rt = (s) => s instanceof HTMLElement, ct = (s) => s instanceof TouchEvent, ht = (s) => s instanceof MouseEvent, lt = (s) => s instanceof PointerEvent, at = (s) => s instanceof TouchList, ut = (s) => s !== void 0, dt = (s) => s === void 0, gt = (s) => s === null, ft = (s) => s == null, K = (s) => `${s}-${Date.now()}-${Math.floor(Math.random() * 1e5)}`, M = (s, t, e) => {
  if (!(!I(s) && !f(s)))
    if (f(s))
      s.forEach(t, e);
    else
...
const _t = {
  ...
  mousemove: r.Move,
  mouseup: r.End
}, mt = ["mousedown"], yt = ["mousemove", "mouseup"];
class N extends x {
  constructor(t, e) {
    super(t, e), this.evEl = mt, this.evWin = yt, this._pressed = !1, this.init();
  }
  handler(t) {
    const e = _t[t.type];
...
class R extends x {
  constructor(t, e) {
    super(t, e), this.evTarget = Mt, this.targetIds = {}, this.init();
  }
  handler(t) {
    const e = vt[t.type], n = this.getTouches(t, e);
...
const Pt = {
  ...
  pointerout: r.Cancel
}, bt = ["pointerdown"], Tt = ["pointermove", "pointerup", "pointercancel", "pointerout"];
class xt extends x {
  constructor(t, e) {
    super(t, e), this.evEl = bt, this.evWin = Tt, this._store = [], this.init();
  }
  handler(t) {
    const e = Pt[t.type], n = t.pointerType === _.Touch;
...
class Et extends x {
  ...
  handler(t, e, n) {
    const i = n.pointerType === _.Touch, o = n.pointerType === _.Mouse;
    if (i)
...
const wt = (s, t, e) => {
  ...
  e.isFirst = !!o, e.isFinal = !!h, o && s.clearSession(), e.eventType = t, zt(s, e), s.options.preventDefault && e.srcEvent.preventDefault(), s.options.stopPropagation && e.srcEvent.stopPropagation(), s.options.stopImmediatePropagation && e.srcEvent.stopImmediatePropagation(), s.emit(v.Secret, e), s.recognize(e), s.session.prevInput = e;
}, zt = (s, t) => {
  var L;
  ...
  t.timestamp = Date.now(), t.deltaTime = t.timestamp - i.timestamp, t.angle = u.getAngle(h, d), t.distance = u.getDistance(h, d), Ft(e, t), t.offsetDirection = u.getDirection(t.deltaX, t.deltaY);
  ...
  const g = s.element;
  F(t.srcEvent.target, g) ? t.target = t.srcEvent.target : t.target = g, At(e, t);
}, V = (s) => {
  const t = [];
  ...
  let t;
  return H ? t = xt : Y ? t = R : E ? t = Et : t = N, new t(s, wt);
}, Lt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  InputUtil: u,
  createInputInstance: G
}, Symbol.toStringTag, { value: "Module" }));
class A {
  constructor(t) {
    this._type = v.Unknown, this._options = { ...t }, this._id = K(this.type), this._manager = null, this._options.enable = this._options.enable ?? !0, this._state = c.Possible, this.simultaneous = {}, this.requireFails = [];
  }
  get type() {
    return this._type;
  }
  ...
  recognizeWith(t) {
    if (f(t) && m(t, "recognizeWidth", this))
      return this;
...
class qt {
  constructor(t, e) {
    this._element = t, this._options = { ...C, ...e }, this._options.inputTarget = (e == null ? void 0 : e.inputTarget) ?? this._element, this._recognizers = [], this._input = G(this), this._touchAction = new Z(this, this._options.touchActions), this._session = {}, this.handlers = {}, this._oldCssProps = {}, this._toggleCssProps("add");
  }
  get element() {
