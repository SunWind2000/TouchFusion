...
const j = 25, H = /mobile|tablet|ip(ad|hone|od)|android/i, z = "ontouchstart" in window || navigator.maxTouchPoints > 0, G = "PointerEvent" in window, U = z && H.test(navigator.userAgent);
...
const Z = [
  ...
  RECOGNIZER_TYPE: v,
  STOP_TYPE: y,
  SUPPORT_ONLY_TOUCH: U,
  SUPPORT_POINTER_EVENTS: G,
  SUPPORT_TOUCH: z,
  TOUCH_ACTION: Y
...
class w extends Error {
  constructor(e) {
    super(e), this.name = "TouchFusionError", Error.captureStackTrace && Error.captureStackTrace(this, w);
  }
}
const te = (s) => {
  throw new w(s);
...
class A {
  ...
  init() {
    this._evEl.length !== 0 && M(this.el, this._evEl, this.domHandler), this._evTarget.length !== 0 && this.target && M(this.target, this._evTarget, this.domHandler), this._evWin.length !== 0 && M(window, this._evWin, this.domHandler);
  }
  destroy() {
...
const pe = {
  ...
  mousemove: c.Move,
  mouseup: c.End
}, me = ["mousedown"], _e = ["mousemove", "mouseup"];
class C extends A {
  constructor(e, t) {
    super(e, t), this.evEl = me, this.evWin = _e, this._pressed = !1, this.init();
  }
  handler(e) {
    const t = pe[e.type];
...
class I extends A {
  constructor(e, t) {
    super(e, t), this.evTarget = ve, this.targetIds = {}, this.init();
  }
  handler(e) {
    const t = ye[e.type], n = this.getTouches(e, t);
  ...
  getTouches(e, t) {
    ...
    const i = n.filter((h) => P(h.target, this.target));
    if (t === c.Start)
...
class be extends A {
  constructor(e, t) {
    super(e, t), this._mouse = new C(e, this.handler), this._touch = new I(e, this.handler), this._primaryTouch = null, this._lastTouches = [];
  }
  handler(e, t, n) {
...
const xe = (s, e, t) => {
  ...
  t.isFirst = !!o, t.isFinal = !!l, o && s.clearSession(), t.eventType = e, Se(s, t), s.emit(v.Secret, t), s.recognize(t), s.session.prevInput = t;
}, Se = (s, e) => {
  var X;
  ...
  const g = s.element;
  P(e.srcEvent.target, g) ? e.target = e.srcEvent.target : e.target = g, ze(t, e);
}, V = (s) => {
  const e = [];
  ...
  let e;
  return U ? e = I : z ? e = be : e = C, new e(s, xe);
}, we = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  InputUtil: u,
  createInputInstance: N
}, Symbol.toStringTag, { value: "Module" }));
class L {
  constructor(e) {
    this._type = v.Unknown, this._options = { ...e }, this._id = J(this.type), this._manager = null, this._options.enable = this._options.enable ?? !0, this._state = r.Possible, this.simultaneous = {}, this.requireFails = [];
  }
  get type() {
    return this._type;
  }
...
class Le {
  constructor(e, t) {
    this._element = e, this._options = { ...k, ...t }, this._options.inputTarget = (t == null ? void 0 : t.inputTarget) ?? this._element, this._recognizers = [], this._input = N(this), this._touchAction = new R(this, this._options.touchActions), this._session = {}, this.handlers = {};
  }
  get element() {
  ...
  destroy() {
    this._recognizers = [], this._input.destroy(), this._session = {}, this.handlers = {};
  }
  /**
